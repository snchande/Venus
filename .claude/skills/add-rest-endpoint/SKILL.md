...
description: Scaffold a new REST endpoint following the Venus controller→service pattern. Use when the user asks to add an API for X. Creates the controller method, a service method, a DTO if needed, an integration test, and updates docs/API.md — preserving the layered architecture.
---
