...
public class ShellSession {
    ...
    private void initJShell() {
        ...
        String[] startupImports = {
            ...
            "import com.venus.util.VenusDisplay;",
        ...
        // VenusInput.STDIN is wired directly into JShell via builder().in() above.
     ...
     * This makes XChart, Commons Math, VenusDisplay, and all other server
