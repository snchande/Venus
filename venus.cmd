...
set "VENUS_HOME=%~dp0"
if "%VENUS_HOME:~-1%"=="\" set "VENUS_HOME=%VENUS_HOME:~0,-1%"
if exist "%VENUS_HOME%\AGENTS.md"       set "VENUS_AGENTS_GUIDE=%VENUS_HOME%\AGENTS.md"
if exist "%VENUS_HOME%\.claude\skills"  set "VENUS_SKILLS_DIR=%VENUS_HOME%\.claude\skills"
if exist "%VENUS_HOME%\.claude\agents"  set "VENUS_AGENTS_DIR=%VENUS_HOME%\.claude\agents"
...
echo !ESC![93m     /^|\_/^|\     !ESC![0m!ESC![90m  Powered by JShell + Spring Boot!ESC![0m
...
if defined VENUS_AI_COPILOTS echo !ESC![90m  AI:       !VENUS_AI_COPILOTS!  co-pilot ready -- run: venus agents!ESC![0m
if not defined VENUS_AI_COPILOTS echo !ESC![93m  AI:       no CLI found -- install Claude / Copilot / Gemini for AI features!ESC![0m
...
if not exist "%JAR%" echo !ESC![93m  JAR: not built yet -- run: venus build!ESC![0m
...
:cmd_welcome
call :banner
echo !ESC![97m  Welcome to Venus Notebooks!ESC![0m
...
echo !ESC![90m         venus start        -^>  http://localhost:8585!ESC![0m
echo !ESC![97m    2^) Drive Venus over MCP!ESC![0m   !ESC![90moperate ^& automate from any MCP client!ESC![0m
...
echo !ESC![90m         run  claude  /  copilot  /  gemini   in this folder, then ask the venus agent!ESC![0m
echo.
call :detect_copilots
if defined VENUS_AI_COPILOTS echo !ESC![92m  AI co-pilots ready: !VENUS_AI_COPILOTS!   run: venus agents!ESC![0m
if not defined VENUS_AI_COPILOTS echo !ESC![93m  No AI CLI found -- install Claude, Copilot, or Gemini to personalize Venus.!ESC![0m
echo.
echo !ESC![96m  THE ONE DIFFERENCE!ESC![0m
echo !ESC![90m  ──────────────────────────────────────!ESC![0m
echo !ESC![90m    This venus CLI operates ^& automates Venus incl. MCP but cannot change its code.!ESC![0m
echo !ESC![90m    An agentic CLI claude / copilot / gemini can ALSO personalize and extend Venus.!ESC![0m
echo.
echo !ESC![96m  NEXT!ESC![0m
echo !ESC![90m  ──────────────────────────────────────!ESC![0m
echo     venus start      Start the server and open the UI
echo     venus docs       Open the brochure and list the docs
echo     venus agents     AI co-pilots, skills ^& the venus agent
echo.
...
:cmd_docs
echo.
echo !ESC![97m  Venus Notebooks -- Documentation!ESC![0m
echo !ESC![90m  ──────────────────────────────────────!ESC![0m
...
echo.
if exist "docs\brochure\venus-brochure.pdf" echo !ESC![92m    Opening the brochure...!ESC![0m
if exist "docs\brochure\venus-brochure.pdf" start "" "docs\brochure\venus-brochure.pdf"
if not exist "docs\brochure\venus-brochure.pdf" echo !ESC![93m    Brochure PDF not found -- open docs\brochure\venus-brochure.html in a browser.!ESC![0m
echo.
exit /b 0
...
:cmd_agents
echo.
echo !ESC![93m        .        !ESC![0m!ESC![97m  Venus AI Co-pilots, Skills ^& Agents!ESC![0m
echo !ESC![93m       /^|\       !ESC![0m!ESC![90m  ──────────────────────────────────────!ESC![0m
echo !ESC![93m      ( @ )      !ESC![0m
echo.
...
echo !ESC![90m  ──────────────────────────────────────!ESC![0m
call :detect_copilots
if not defined VENUS_AI_COPILOTS goto :agents_nocli
...
echo !ESC![90m      VENUS_HOME=%VENUS_HOME%!ESC![0m
echo !ESC![90m      VENUS_AGENTS_GUIDE=%VENUS_AGENTS_GUIDE%!ESC![0m
echo !ESC![90m      VENUS_SKILLS_DIR=%VENUS_SKILLS_DIR%!ESC![0m
echo !ESC![90m      VENUS_AGENTS_DIR=%VENUS_AGENTS_DIR%!ESC![0m
echo.
exit /b 0
...
echo    !ESC![97mwelcome!ESC![0m           Common welcome -- open the UI, use MCP, or personalize Venus
echo    !ESC![97mdocs!ESC![0m              Open the brochure and list the documentation
echo    !ESC![97magents!ESC![0m            Show AI co-pilots, skills ^& the venus agent wired into this repo
...
echo    venus status            Check server + Java + Node.js + .NET
...
:detect_copilots
set "VENUS_AI_COPILOTS="
where claude  >nul 2>&1 && set "VENUS_AI_COPILOTS=!VENUS_AI_COPILOTS! Claude"
where copilot >nul 2>&1 && set "VENUS_AI_COPILOTS=!VENUS_AI_COPILOTS! Copilot"
if not defined VENUS_AI_COPILOTS where github-copilot-cli >nul 2>&1 && set "VENUS_AI_COPILOTS=!VENUS_AI_COPILOTS! Copilot"
where gemini  >nul 2>&1 && set "VENUS_AI_COPILOTS=!VENUS_AI_COPILOTS! Gemini"
REM Trim leading space
if defined VENUS_AI_COPILOTS if "!VENUS_AI_COPILOTS:~0,1!"==" " set "VENUS_AI_COPILOTS=!VENUS_AI_COPILOTS:~1!"
exit /b 0
